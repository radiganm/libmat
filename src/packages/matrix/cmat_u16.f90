...
!! NOTICE:  This source file was automatically generated on 2017-06-25 03:25:54 by dox.
  ...
  contains
    ...
    subroutine add(y,x1,x2)
      ...
      type(CMatrix_u16), intent(inout)        :: y
      type(CMatrix_u16), intent(inout)        :: x1
      type(CMatrix_u16), intent(inout)        :: x2
      type(integer*2), pointer                 :: b(:)
      type(integer*2), pointer                 :: a1(:)
      type(integer*2), pointer                 :: a2(:)
      type(integer*8)                       :: k
      type(integer*8)                                :: N 
    ...
    subroutine axby(y,a1,x1,a2,x2)
      ...
      type(CMatrix_u16), intent(inout)        :: y
      type(integer*2), intent(in)                    :: a1
      type(CMatrix_u16), intent(inout)        :: x1
      type(integer*2), intent(in)                    :: a2
      type(CMatrix_u16), intent(inout)        :: x2
      type(integer*2), pointer                       :: p(:)
      type(integer*2), pointer                       :: p1(:)
      type(integer*2), pointer                       :: p2(:)
      type(integer*8)                                :: k
      type(integer*8)                                :: N 
      N = y%info%dims(1)*y%info%dims(2)
    ...
    subroutine c2f(x, p)
      ...
      type(CMatrix_u16), intent(in)           :: x
      type(integer*2), pointer, intent(inout)  :: p(:,:)
      type(integer*8)                       :: k
    ...
    subroutine eye(x)
      ...
      type(CMatrix_u16), intent(inout)        :: x
      type(integer*2), pointer                       :: p(:,:)
      type(integer*8)                                :: k
      call c_f_pointer(x%data, p, [x%info%dims(1), x%info%dims(2)])
    ...
    subroutine pow(y, x, n)
      ...
      type(CMatrix_u16), intent(inout)        :: y
      type(CMatrix_u16), intent(inout)        :: x
      type(integer*2), pointer                       :: a(:,:)
      type(integer*2), pointer                       :: b(:,:)
      type(integer*2), intent(in)                    :: n
      type(integer*8)                                :: k1
      type(integer*8)                                :: k2
      type(integer*8)                                :: k
      type(integer*8)                                :: r
    ...
    subroutine show_named2(p, sname_length, sname)
      ...
      type(integer*2), pointer, intent(in)                :: p(:,:)
      integer(c_size_t), intent(in), value             :: sname_length
      type(c_ptr), intent(in), value                   :: sname
      character(kind=c_char,len=sname_length), pointer :: xname
      type(disp_settings)                              :: ds
