...
extern "C" {
  ...
  extern void __cmat_s_MOD_fill(CMatrix_s_t x, float *val, uint64_t *r1, uint64_t *r2, uint64_t *c1, uint64_t *c2);
  extern void __cmat_s_MOD_mul(CMatrix_s_t y, CMatrix_s_t x1, CMatrix_s_t x2);
  extern void __cmat_s_MOD_pow(CMatrix_s_t y, CMatrix_s_t x, float *n);
