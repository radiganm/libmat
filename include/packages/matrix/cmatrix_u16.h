...
extern "C" {
  ...
  extern void __cmat_u16_MOD_fill(CMatrix_u16_t x, uint16_t *val, uint64_t *r1, uint64_t *r2, uint64_t *c1, uint64_t *c2);
  extern void __cmat_u16_MOD_mul(CMatrix_u16_t y, CMatrix_u16_t x1, CMatrix_u16_t x2);
  extern void __cmat_u16_MOD_pow(CMatrix_u16_t y, CMatrix_u16_t x, uint16_t *n);
